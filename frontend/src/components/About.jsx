        ...
        <Col lg={8} className="mx-auto">
          <Card className="border-0 shadow-sm">
            <Card.Body className="p-5" style={{ textAlign: 'text-left' }}>
              ...
              <p>
                I actively document my DevOps journey and insights on  <a href="https://www.linkedin.com/in/madubuikeolisa/" target="_blank" rel="noopener noreferrer"><u>LinkedIn</u></a>, where I share challenges I encounter in the DevOps world and other things DevOps related
              </p>

              <h4 className="mt-4">Beyond the screen</h4>
              <p>
                When I am not building and automating, I enjoy exploring good food, participating in sports, watching football and keeping fit. I am also a massive comic book & anime fan!
              </p>

              <h4 className="mt-4">Let’s Connect</h4>
              <p>
                I am always open to discussing collaboration and new opportunities in DevOps and cloud engineering. Feel free to reach out to me at <a href="mailto:youfoundolisa@gmail.com">youfoundolisa@gmail.com</a>
              </p>
            </Card.Body>
